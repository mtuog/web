...
public class HomeController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
          ...
          String email = request.getParameter("lay_email");
          String password =  request.getParameter("lay_pass");
          if("Yukihira Yato".equals(username.trim()) &&"yukihirayato@gmail.com".equalsIgnoreCase(username.trim()) && "123456789".equals(password) ) {
              ...
              request.setAttribute("thongBaoLoi","Tên user đăng nhập không chính xác");
